...
class BluetoothTools: iBluetooth, CBCentralManagerDelegate {
...
/**
 蓝牙工具: 中心设备
 */
class BluetoothCentral: iBluetooth, CBCentralManagerDelegate, CBPeripheralDelegate {
...
class BluetoothPeripheral: iBluetooth, CBPeripheralManagerDelegate {
